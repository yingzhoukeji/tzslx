...
<li><a href='/index.php/Register/index'>提交报名</a></li>
          <li><a href='/index.php/Register/query'>证件查询</a></li>
          <li class="on"><a href='/index.php/Register/queryscore'>名次查询</a></li>
						...
						if(type==0){
							var html=buildlist("姓名；"+marathon.name);
								...
								if(marathon.score!=undefined&&marathon.score!=null&&marathon.score!="null"){
									html+=buildlist("我的成绩："+marathon.scoretime);
									html+=buildlist("我的名次："+marathon.score);
									html+=buildlist("<a style='color:blue;' href='<?php echo U('Register/chengji');?>?id="+marathon.id+"'>颁发证书，点击查看<a>");
								}else{
