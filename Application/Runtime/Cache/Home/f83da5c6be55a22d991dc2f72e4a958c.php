...
<li class="gnb_05"><a href="/index.php/page/index/name/spzx" class="gnb_link">联系我们</a> </li>
  ...
  <div id="container" class="sub_wrap"> 
    ...
    <div class="sv K05"><b class="busjk"><?php echo ($info["page_name"]); ?></b><span class="sv_line"></span>
      <p>KUASHI SPORTS</p>
    </div>
    ...
    <div class="inner sub_ct"> 
      ...
      <div class="sub_l">
        ...
        <div class="xiaodaoh">
           <ul>
           <?php if(is_array($catlist)): $i = 0; $__LIST__ = $catlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li  class="on"><a href='<?php echo U("page/index",array("name"=>$vo["unique_id"]));?>'><?php echo ($vo["page_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="xiaodaoh">
           <img src="/img/1-1.jpg">
           <ul>
             <?php if(is_array($subcatlist)): $i = 0; $__LIST__ = $subcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href='<?php echo U("page/index",array("name"=>$vo["unique_id"]));?>'><?php echo ($vo["page_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
