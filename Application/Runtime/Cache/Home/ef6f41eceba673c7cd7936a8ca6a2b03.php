...
<li class="gnb_05"><a href="/index.php/page/index/name/spzx" class="gnb_link">联系我们</a> </li>
  ...
  <div id="container" class="sub_wrap"> 
    ...
    <div class="sv K03"><b class="busjk"><?php echo (L("T_MESSAGE")); ?></b><span class="sv_line"></span>
      <p>KUASHI SPORTS</p>
    </div>

    <div class="snb_wrap ">
      <ul class="snb snb_col04">
    <li class="on"><a href="/index.php/message/index">在线留言</a></li>
    <li><a href="/index.php/page/index/name/shfw">合作方式</a></li>
    <li><a href="/index.php/page/index/name/dszlxz">加盟联系</a></li>
...
<div style="height:360px; width:96.5%; padding:0 ; margin:0 0 20px 0; overflow:hidden; border-bottom:#CBCBCB solid 1px;">
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.39096,28.658149);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"台州蓝协",content:"公司地址：浙江省台州市体育中心<br/>服务热线：0576-88803456",point:"121.39096|28.658149",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
...
<dl>
  <dt><?php echo (L("T_NAME")); ?></dt>
  <dd><input type="text" name="username" id="name" value=""/></dd>
</dl>
<dl>
  <dt><?php echo (L("T_EMAIL")); ?></dt>
  <dd><input type="text" name="email" id="email" value="" /></dd>
</dl>
<dl>
  <dt><?php echo (L("T_MOBILE")); ?></dt>
  <dd><input type="text" name="moblie" id="moblie" value="" /></dd>
</dl>
<dl>
  <dt><?php echo (L("T_MESSAGE_CONTENT")); ?></dt>
  <dd><textarea name="content" id="message" style="height: 80px;"></textarea></dd>
</dl>
<dl>
  <dt><?php echo (L("T_CODE")); ?></dt>
  <dd><input name="verify_code" id="verify_code" type="text" size="20" value="" style=" width:30%;" />
    <img src="<?php echo U('Base/verify_code');?>"  title="看不清？单击此处刷新" onclick="this.src+='?rand='+Math.random();"  style="cursor: pointer; vertical-align: middle;"/></dd>
</dl>
<p><input name="submitted" id="submitted" value="提 交 留 言" type="submit" class="submit" /></p>
