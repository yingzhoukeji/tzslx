...
<li class="gnb_05"><a href="/index.php/page/index/name/spzx" class="gnb_link">联系我们</a> </li>
  ...
  <div id="container" class="sub_wrap"> 
    ...
    <div class="sv K02"><b class="busjk"><?php echo (L("T_PRODUCT")); ?></b><span class="sv_line"></span>
      <p>KUASHI SPORTS</p>
    </div>



<div class="outer outer_tinted">
			<div class="inner sub_ct">
				...
				<!-- Board Wrap -->
				<div class="board-wrap garden_load">
		<ul class="thumb_list gd_diary">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('product/read',array('id'=>$vo['id']));?>">
								<p class="img"><img src="<?php echo get_default_img($vo['image_id']);?>" alt="<?php echo ($vo["title"]); ?>"></p>
								<div class="txt">
									<h4><?php echo ($vo["title"]); ?></h4>
									<p class="date"><?php echo cutStr($vo['summary'],40,0);?></p>
								</div>
							</a>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					
					<p class="list-pager align-c mt20" title="페이지 이동하기">
					<a href="">&lt;&lt;</a> <a href="">&lt;</a> <span> <a href='' class="on">1</a> </span> <a href="">&gt;</a> <a href="">&gt;&gt;</a> 
					</p></div>
