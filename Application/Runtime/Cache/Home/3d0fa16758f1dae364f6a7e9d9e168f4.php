...
<li class="gnb_05"><a href="/index.php/page/index/name/spzx" class="gnb_link">联系我们</a> </li>
  ...
  <div id="container" class="sub_wrap"> 
    ...
    <div class="sv K03"><b class="busjk"><?php echo (L("T_PRODUCT")); ?></b><span class="sv_line"></span>
      <p>KUASHI SPORTS</p>
    </div>

    <div class="snb_wrap ">
      <ul class="snb snb_col04">
    <li class="on"><a href="/index.php/page/index/name/rczl">VIP服务</a></li>
    <li><a href="/index.php/page/index/name/jltd">VIP等级</a></li>
    <li><a href="/index.php/page/index/name/qqyxwl">健身常识</a></li>
    <li><a href="/index.php/page/index/name/gnxswl">BMI测试</a></li>
      </ul>
    ...
    <div class="inner sub_ct"> 
      ...
      <div class="sub_l">
        ...
        <div class="xiaodaoh">
           <ul>
           <?php $__m_cat=M("category");$__cat_list=$__m_cat->where("lang='zh-cn'  AND type='p' AND pid=0")->limit()->select();foreach($__cat_list as $_ck=>$_cv):$cid=$_cv['cid'];$child=$__m_cat->where('pid='.$cid)->order('cid DESC')->select();extract($_cv);?><li><a href='<?php echo U("product/index",array("cid"=>$cid));?>'><?php echo ($name); ?></a></li><?php endforeach; ?>
            </ul>
        </div>
        <div class="xiaodaoh">
           <img src="/img/1-1.jpg">
           <ul>
             <?php $__m_cat=M("category");$__cat_list=$__m_cat->where("lang='zh-cn'  AND type='p' AND pid=$_GET[cid]")->limit()->select();foreach($__cat_list as $_ck=>$_cv):$cid=$_cv['cid'];$child=$__m_cat->where('pid='.$cid)->order('cid DESC')->select();extract($_cv);?><li><a href='<?php echo U("product/index",array("cid"=>$cid));?>'><?php echo ($name); ?></a></li><?php endforeach; ?>
            </ul>
        </div>
...
<div class="danyewg">
<h4><?php echo ($webtitle); ?></h4>
<div class="jiedan"><samp><?php echo date('Y-m-d',$info['published']);?></samp>   栏目：<?php echo ($info["cname"]); ?></div>
<div class="nerrong">
<!-- if condition="$info['image_id'] neq 0">
<a href="/index.html"><img src="<?php echo get_default_img($info['image_id']);?>" alt="" border="0" /></a>
</if -->
