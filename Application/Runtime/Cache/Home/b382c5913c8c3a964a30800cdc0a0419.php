...
<li class="gnb_05"><a href="/index.php/page/index/name/spzx" class="gnb_link">联系我们</a> </li>
  ...
  <div id="container" class="sub_wrap"> 
    ...
    <div class="sv K01"><b class="busjk"><?php echo (L("T_NEWS")); ?></b><span class="sv_line"></span>
      <p>KUASHI SPORTS</p>
    </div>
    ...
    <div class="inner sub_ct"> 
      ...
      <div class="sub_r lectr_wrap">
        ...
        <div class="board-wrap notice_load">
          ...
          <ul class="board-list">
            <li class="head">
              <div>
                <h6 class="title w75 m-w100">标题</h6>
                <p class="date w25 m-auto">时间</p>
              </div>
            </li>
            
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
    <div>
      <h6 class="title w75 m-w100"><a href="<?php echo U('news/read',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></h6>
      <p class="date w25 m-auto"><?php echo date('Y/m/d',$vo['published']);?></p>
    </div>
  </li><?php endforeach; endif; else: echo "" ;endif; ?>
 
          </ul>
       
          <p class="list-pager align-c mt30" title="分页">
          <a href="">&lt;&lt;</a>
          <a href="">&lt;</a>
