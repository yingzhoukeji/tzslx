...
."emergencycontactname,emergencycontactphone,guardian,guardianphone,guardiancid,guardianrelationship,ip,istz,createtime)"
...
."','".$data['guardian']."','".$data['guardianphone']."','".$data['guardiancid']."','".$data['guardianrelationship']."','".$_SERVER["REMOTE_ADDR"]."',".$data['istz'].",'".date('Y-m-d H:m:s', time())."')";
