...
$input->SetNotify_url("http://www.tzslx.com/regiser/test/notify.php");
 ...
 */
 function updateOpenid($id,$myopenid){
	 $rs= $conn->query('UPDATE pa_marathon SET openid="'.$myopenid.'" WHERE id ='.$id);
	 if($rs){
		//echo json_encode(array("status"=>1,"msg"=>"更新成功"));
	}else{
		//echo json_encode(array("status"=>0,"msg"=>"更新失败"));
...
@keyframes sk-circleBounceDelay {
  ...
  40% {
	...
	function updatePay(){
		...
		$.getJSON("updatepaystatus.php?id="+id+"&orderid="+orderid+"&openid="+openid,function(json){
