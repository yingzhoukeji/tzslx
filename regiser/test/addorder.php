...
<html>
	...
	<body>
		<div class="mui-content mui-scroll">
			<div class="welcome">欢迎<span style="color:red;"><?php echo $_SESSION["nickname"];  ?></span>购买大森产品！该产品需要支付<span style="color:red;"><?php echo $deposit;?></span>定金</div>
			<form id="joinForm" class="mui-input-group" action="addorder_submit.php" method="post">
					...
					<div class="mui-button-row">
						<button type="button" id="mysubmit" class="mui-btn mui-btn-primary">确定购买</button>
						<button type="button" id="back" class="mui-btn mui-btn-primary">取消</button>
					</div>
...
<nav class="mui-bar mui-bar-tab">
	...
	<a class="mui-tab-item mui-active" href="/wxhd/bargain/test/">
		<span class="mui-icon mui-icon-starhalf"></span>
		<span class="mui-tab-label">砍价活动</span>
	</a>
    <a class="mui-tab-item" href="/wxhd/bargain/test/">
		<span class="mui-icon mui-icon-list"></span>
		<span class="mui-tab-label">砍价销售榜</span>
	</a>
	<a class="mui-tab-item" href="http://www.dosochina.com/wxhd/list.html">
