...
.mui-radio input{float:left !important; left:0px}
	...
	<body><div style="height:50px; clear:bothl; overflow:hidden;background:#33276f !important; padding:0px !important; margin:0px !important;">
		...
		<div class="mui-content" style=" margin-bottom: 58px;padding-top: 5px;padding-left: 10px; padding-right: 10px;">
			<div class="mui-input-row">
				<label style="color:red;">成绩查询：</label>
			</div>	
			<div class="mui-input-row">
				<label>查询方式：</label>
			...
			<a class="mui-tab-item mui-active" id="tel" href="searchscore.php">
					...
					if(json.length>0){
						...
						if(type==0){
							var html=buildlist("姓名；"+marathon.name);
								...
								if(marathon.score!=undefined&&marathon.score!=null&&marathon.score!="null"){
									html+=buildlist("我的成绩："+marathon.score);
								}else{
									html+=buildlist("我的成绩：暂无成绩");
								}
							...
							var html=buildlist("姓名；"+marathon.name);
								...
								//html+=buildlist("国籍："+marathon.nationalityid);
