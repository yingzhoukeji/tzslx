    ...
    <div class="container_16" style="padding-top: 6px;">
        ...
        <div class="grid_6" style="text-align: right;">
                <?php if(C('SITE_INFO.LANG_SWITCH_ON')){ ?>
                    [<a href="/index.php/Home/News?l=zh-cn" style='cursor:pointer;' title='简体中文'>简体中文</a>]
                    [<a href="/index.php/Home/News?l=en-us" style='cursor:pointer;' title='English'>English</a>]
					[<a href="/index.php/Home/News?l=ru" style='cursor:pointer;' title='русский '>русский </a>]
					[<a href="/index.php/Home/News?l=spain" style='cursor:pointer;' title='El espa~nol'>El espa~nol</a>]
...
<div class="main"><!-- MAIN -->
    <div class="container_12">
        ...
        <div class="grid_9">
            <div class="list-type">
                <ul>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('news/read',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a><span style="float: right;"><?php echo date('Y/m/d',$vo['published']);?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        </div>
    ...
    <div class="container_12">
        ...
        <div class="grid_3">
            ...
            <div class="list-type-footer">
                ...
                <p class="grey">
                    Email: <a href="conist@YZ1681.COM" class="grey">conist@YZ1681.COM</a>
                </p>
            </div>
        </div>
    </div>
